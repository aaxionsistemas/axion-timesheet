...
interface ConsultantRevenueChartProps {
  consultantName?: string;
}

export default function ConsultantRevenueChart({ consultantName }: ConsultantRevenueChartProps) {
  ...
  const loadMonthlyRevenue = async () => {
    try {
      setLoading(true);
      const revenueData = await ChartService.getMonthlyRevenue(consultantName);
      setData(revenueData);
    } catch (error) {
